...
namespace RTC
{
	...
	SimpleConsumer::SimpleConsumer(
	  ...
	  : RTC::Consumer::Consumer(shared, id, producerId, mediaKind, listener, data, RTC::RtpParameters::Type::SIMPLE)
	{
		MS_TRACE();
		...
		std::cout << "create simple consumer" << std::endl;
	}
	...
	{
		//std::cout << "SimpleConsumer::SendRtpPacket" << std::endl;
		MS_TRACE();
